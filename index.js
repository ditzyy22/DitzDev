...
*/
require('./settings')
const { default: makeWASocket, useMultiFileAuthState, DisconnectReason, generateForwardMessageContent, generateWAMessageFromContent, downloadContentFromMessage, makeInMemoryStore, jidDecode, proto } = require("@whiskeysockets/baileys")
const fs = require('fs')
...
console.log(color(figlet.textSync("Yori", {
    font: 'DOS Rebel',
...
✉️  Script Yori Chan
✉️  Author : ErerexID Chx
✉️  Gmail : luwibu@gmail.com
✉️  Instagram : Anonymous
